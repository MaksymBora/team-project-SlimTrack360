...
`,Pe=w.div`
  ...
  align-items: center;
  gap: 12px;
`,ze=({handleSelect:e})=>{const[t,n]=h.useState(null),s=h.useRef(),d=o=>{n(o.target.files[0]),e(o.target.files[0])},i=()=>{s.current.click()};return a.jsxs("div",{children:[a.jsxs(Pe,{children:[a.jsx(Fe,{children:a.jsx("img",{src:he,width:"36px",height:"36px",alt:"Profile Photo"})}),a.jsxs(Se,{type:"button",onClick:i,children:[a.jsx(ye,{name:"icon-direct-inbox",width:"16px",height:"16px",fill:"#E3FFA8"}),t?t.name:"Download new photo"]})]}),a.jsx(De,{ref:s,type:"file",onChange:d,accept:"image/*,.png,.jpg,.web,.gif"})]})},Ue=w.form`
  display: grid;
