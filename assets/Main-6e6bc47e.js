import{u as t,t as n,L as W,e as o,v as T,w as P,j as e,r as w,a as k,R as N,O as _,C as q,T as H,F as K,x as J,I as Q,y as X,z as Y,A as Z,h as j,B as U,D as ee,E as te,G as ne,H as ie,J as ae,K as oe,q as re,p as se,f as le}from"./index-7bf4305a.js";import{I as u}from"./Icon-394b8167.js";import{C as S,a as de,L as ce,B as pe,p as xe,c as M,d as E,f as he,A as ge,D as me}from"./index-debe4999.js";import{v as fe,w as ue,x as we,y as ye,R as be,g as je,a as ke,b as Ce,c as $e,d as ve,e as We,f as Ie,h as Be,i as ze,j as Fe,k as Le,l as De,z as Ge,m as Te,o as I,r as B,n as Pe,q as Se,p as Me,t as Ee,s as Re,u as Oe}from"./RecordDiaryModal-8cdb05ba.js";import{c as Ve,a as Ae,b as Ne,I as _e}from"./Item-8366cb00.js";import"./index-387d7a00.js";import"./index.esm-8134001c.js";const qe=t.div`
  display: flex;
...
`,Dt=t.p`
  width: 78px;
`,$=i=>{const{title:a,chartBcg:s,elementGoal:l,elementValue:d}=i;let c=(l-d).toFixed(1);c<0&&(c=0);let r=Math.round(d*100/l);return(r===1/0||isNaN(r))&&(r=0),r>100&&(r=100),e.jsx(e.Fragment,{children:e.jsxs(vt,{children:[e.jsxs(Wt,{children:[e.jsx(R,{dailyCalories:l,inputValue:d,chartBcg:s}),e.jsx(It,{children:e.jsx("p",{children:`${r}%`})})]}),e.jsxs(Bt,{children:[e.jsx(zt,{children:a}),e.jsxs(Ft,{children:[e.jsxs(Lt,{children:["Goal: ",e.jsx(G,{children:l})]}),e.jsxs(Dt,{children:["left: ",e.jsx(G,{children:c})]})]})]})]})})},Gt=t.h2`
  color: ${n.color.primaryWhite};
  font-size: 18px;
  // font-weight: 400;
  line-height: 1.33;
...
`,Mt=t.div`
  ...
  flex-direction: column;
  row-gap: 12px;
`,Et="rgba(255, 196, 247, 1)",Rt="rgba(255, 243, 183, 1)",Ot="rgba(182, 182, 182, 1)",Vt=()=>{const i=o(te),a=o(ne),s=o(ie),l=o(T),d=o(fe),c=o(ue),r=o(we),m=o(ye)||0;let f="#45FFBC";return e.jsxs("div",{children:[e.jsx(Gt,{children:"Food"}),e.jsxs(Tt,{children:[e.jsxs(Pt,{children:[e.jsx(R,{dailyCalories:l,inputValue:m,chartBcg:f}),e.jsxs(St,{children:[e.jsx("p",{children:m}),e.jsx("p",{children:"calories"})]})]}),e.jsxs(Mt,{children:[e.jsx($,{title:"Carbonohidrates",chartBcg:Et,elementGoal:i,elementValue:c}),e.jsx($,{title:"Protein",chartBcg:Rt,elementGoal:a,elementValue:d}),e.jsx($,{title:"Fat",chartBcg:Ot,elementGoal:s,elementValue:r})]})]})]})},At=t.div`
  @media screen and (min-width: 834px) {
    display: flex;
    column-gap: 8px;
    align-items: center;
...
`,cn=()=>{const i=o(Ve),a=o(Ae),s=o(Ne),d=oe.useMediaQuery({maxWidth:833})?2:4;return e.jsxs("div",{children:[e.jsx(on,{children:"Recommended food"}),a&&e.jsx(re,{}),s?e.jsx("p",{children:"Oops...something went wrong! Try again later"}):e.jsx(rn,{children:i.slice(0,d).map(c=>e.jsx(sn,{children:e.jsx(_e,{item:c})},c._id))}),e.jsxs(dn,{to:"/recommended-food",children:[e.jsx(ln,{children:"See more"}),e.jsx(u,{name:"icon-arrowright",width:"16px",height:"16px",fill:`${n.color.primaryGrey}`})]})]})},wn=()=>{const i=k(),a={date:j};return w.useEffect(()=>{i(se()),i(le(a))},[i]),e.jsxs(qe,{children:[e.jsxs(He,{children:[e.jsx(Ke,{children:"Today"}),e.jsxs(Je,{to:"/dashboard",children:[e.jsx(Qe,{children:"On the way to the goal"}),e.jsx(u,{name:"icon-arrowright",width:"16px",height:"16px",fill:`${n.color.primaryGrey}`})]})]}),e.jsxs(Xe,{children:[e.jsx(nt,{}),e.jsx(kt,{}),e.jsx(Vt,{})]}),e.jsxs(Ye,{children:[e.jsx(an,{}),e.jsx(cn,{})]})]})};export{wn as default};
