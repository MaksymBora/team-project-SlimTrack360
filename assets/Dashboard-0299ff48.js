...
`;const Y=s=>s.statistic.requestMonth,K=s=>({January:1,February:2,March:3,April:4,May:5,June:6,July:7,August:8,September:9,October:10,November:11,December:12})[s];function Q(){const s=C(Y),a=p();return console.log("select",s),c.useEffect(()=>{const r={month:K(s)};console.log(r),a(y(r))},[a,s]),e.jsxs(P,{children:[e.jsx(U,{}),e.jsxs("div",{className:"caloriesWaterGraphs",children:[e.jsx($,{}),e.jsx(I,{})]}),e.jsx(J,{})]})}export{Q as Dashboard,Q as default};
